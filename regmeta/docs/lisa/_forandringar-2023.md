...
Konstnärsnämndens stipendier och bidrag syftar till att främja yrkesverksamma konstnärers möjligheter att bedriva, fördjupa och utveckla sin konstnärliga verksamhet, främja konstnärlig utveckling samt stödja nyskapande kultur.
## **Operativ verksamhetsledare (OpVLedare)**
Operativa verksamhetsledare (OVL) är en reviderad version av operativa företagsledare (OPF). Förutom att metoden är uppdaterad med bland annat nya indatakällor innehåller OVL även verksamhetsledare inom offentlig sektor.
...
Image /page/0/Picture/14 description: This image shows a black logo on a white background. The logo consists of the letters "SCB" in a bold, stylized, sans-serif font. The letters are arranged horizontally, with the central letter "C" being taller than the flanking letters "S" and "B".
...
Ersättning för karensavdrag (karensdag) och Ersättning till riskgrupper upphörde båda den 1 april 2022.
Variabler i LISA: Riskgrupp_Bdag Riskgrupp_Ndag Riskgrupp_Belopp RiskgruppErs Karensers_Bdag Karensers_Belopp Karensers_Egf_Bdag Karensers_Egf_Belopp Karensers_Anst_Bdag Karensers_Anst_Belopp KarensErs
#### **Stipendium**
