...
RAKS är en sammanställning och vidareutveckling av variabler som finns i den registerbaserade arbetsmarknadsstatistiken (RAMS) och i LISA-databasen. Målsättningen är att beskriva en individs totala försörjning och anknytning till arbetsmarknaden med helåret som referensperiod.
