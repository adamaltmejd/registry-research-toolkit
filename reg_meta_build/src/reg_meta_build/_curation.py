...
`require_fqid`, `resolve_variable_id`, `resolve_register_id`) serve all 11
`[[entry]]` curation-TOML loaders — `codelivery.py`, `fold_overrides.py`,
`column_merges.py`, `concept_groups.py`, `tags.py`, `family_merges.py`,
