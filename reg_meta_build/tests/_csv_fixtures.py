...
def _var_row(
    *,
    ...
    varopdef: str = "",
    varsource: str = "",
    population_name: str = "Hela befolkningen",
    population_definition: str = "Alla personer",
    population_comment: str = "",
    population_date: str | None = None,
    object_name: str = "Person",
    object_definition: str = "Fysisk person",
    ...
    return _ri_row(
        ...
        population_comment,
        population_date if population_date is not None else f"{year}-12-31",
        object_name,
        object_definition,
        varname,
        vardef,
