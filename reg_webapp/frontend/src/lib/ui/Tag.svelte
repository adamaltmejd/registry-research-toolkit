...
//
// The base is copy-faced (frontend/DESIGN.md binds the tag primitive to UI copy): a
// tag label is a word of UI text. `mono` opts a tag into --font-mono for the
// exception, an identifier shown as a tag.
