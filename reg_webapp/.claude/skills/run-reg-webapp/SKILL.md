...
focus and its visible ring sit once an Apply has resolved, and what the browser's own
IndexedDB holds across reloads — and does not hold after a refusal) and writes 64 PNGs
