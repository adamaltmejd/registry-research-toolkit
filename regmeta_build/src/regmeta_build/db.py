"""Build pipeline for the regmeta SQLite database.
...
live in `regmeta.db`; this module imports them rather than redefining.
"""
...
from regmeta.fqid import derive_variable_slug
