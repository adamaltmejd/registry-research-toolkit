"""Build pipeline for the regmeta doc index.

Parses frontmatter + markdown bodies under a curated docs directory and
writes the FTS5-indexed `regmeta_docs.db`. Connection management and
schema-compat checks live in `regmeta.doc_db`; this module imports the
...
from regmeta.doc_db import DOC_DB_FILENAME, DOC_SCHEMA_VERSION
