...
**A5.2 read + write surface COMPLETE** (A5.2a + A5.2b-i + A5.2b-ii merged); only A5.2c (kit, deferred) remains, so the box stays unchecked but **A5.3 (SPA, codegens against A5.2's OpenAPI) is unblocked**. {A5.3, A5.4} are next.
