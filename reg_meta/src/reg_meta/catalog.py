...
class Catalog:
    ...
    def _classification_chain_rows(
        ...
        `name` + `valid_from`). Every chain slug is a live row (the validator forbids
        ...
        a NULL column and stays in the map. `short_name` is the compact human label.
        `valid_from` is the edition's OWN point-in-time vintage year (an INTEGER; vintage lives in slug + name +
