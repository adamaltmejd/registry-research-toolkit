"""Self-update logic for reg_meta package, main database, and doc DB."""
...
def run_update(
    ...
    *,
    ...
    """Update reg_meta package, main database, and doc DB to the latest release.
    ...
    if current_parsed >= latest_parsed:
        ...
        if proc.returncode != 0:
            raise RegMetaError(
                ...
                remediation=(
                    "Check that reg_meta was installed with `uv tool install reg-meta`."
                ),
            )
